...
import app.te.protein_chef.databinding.ItemSubPackageCategoryBinding

class PackageSubCategoriesAdapter :
  RecyclerView.Adapter<PackageSubCategoriesAdapter.ViewHolder>() {
  var lastSelected = -1
  var lastPosition = 0
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    val view =
      LayoutInflater.from(parent.context).inflate(R.layout.item_sub_package_category, parent, false)
  ...
  inner class ViewHolder(itemView: View) :
    ...
    lateinit var itemLayoutBinding: ItemSubPackageCategoryBinding
